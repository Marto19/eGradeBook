...
public class JwtService {
    ...
    public boolean isTokenValid(String token, UserDetails userDetails){
        final String email = extractUsername(token); // extractUsername now returns email
        User user = (User) userDetails;
        return (email.equals(user.getEmail())) && !isTokenExpired(token); // Use email instead of username
    }
